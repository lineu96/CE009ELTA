...
soma_remotas <- rowSums(notas[,c('REMOTA 1', 'REMOTA 2',
                                          'REMOTA 3', 'REMOTA 4')], na.rm = T)

menor_remota <- pmin(notas$`REMOTA 1`, 
                     notas$`REMOTA 2`, 
                     notas$`REMOTA 3`, 
                     notas$`REMOTA 4`,
                     na.rm = T)

notas$`MÉDIA REMOTAS` <- (soma_remotas - menor_remota)/3

pre_exame <- round(rowSums(notas[,c('PROVA 1', 
                                  'PROVA 2',
                                  'PROVA 3', 
                                  'MÉDIA REMOTAS')], 
                         na.rm = T)/4, 2)
